...
public class User {
    ...
    public User(String id, String phone, String password, String pic_img, String ahama, String name, String sex, String city, String sign, String status, Date reg_date, String salt) {
        this.id = id;
        this.phone = phone;
