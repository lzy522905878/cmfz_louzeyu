                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button type="button" class="btn btn-warning">
                                        <a href="javascript:$('#xxx').load('${path}/user/user.jsp')">
                                            用户信息
                                        </a>
                                    </button>
                                </li>
                                ...
                                <li>
                                    <button type="button" class="btn btn-warning">
                                        <a href="javascript:$('#xxx').load('${path}/user/userEcharts.jsp')"
                                ...
                                <li>
                                    <button type="button" class="btn btn-warning">
                                        <a href="javascript:$('#xxx').load('${path}/user/userMap.jsp')"
                                           data-toggle="modal" data-target="#myModal">
                                            用户分布
                                        </a>
                                    </button>
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button type="button" class="btn btn-success">
                                        <a href="javascript:$('#xxx').load('${path}/banner/banner.jsp')">
                                            轮播图信息
                                        </a>
                                    </button>
                                </li>
                    ...
                    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button type="button" class="btn btn-warning">
                                        <a href="javascript:$('#xxx').load('${path}/album/album.jsp')">
                                            专辑信息
                                        </a>
                                    </button>
                                </li>
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li>
                                    <button type="button" class="btn btn-danger">
                                        <a href="javascript:$('#xxx').load('${path}/article/article.jsp')">
                                            文章信息
                                        </a>
                                    </button>
                                </li>
